...
public sealed class ToggleTeachingAssignmentStatusCommandValidator : AbstractValidator<ToggleTeachingAssignmentStatusCommand>
{
    public ToggleTeachingAssignmentStatusCommandValidator()
    {
