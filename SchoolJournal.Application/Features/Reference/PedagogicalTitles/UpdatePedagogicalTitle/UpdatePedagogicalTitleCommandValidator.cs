...
public sealed class UpdatePedagogicalTitleCommandValidator : AbstractValidator<UpdatePedagogicalTitleCommand>
{
    public UpdatePedagogicalTitleCommandValidator()
    {
        RuleFor(x => x.TitleId)
