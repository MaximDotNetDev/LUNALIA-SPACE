...
public sealed class GenerateTrueFalseFromPdfCommandValidator : AbstractValidator<GenerateTrueFalseFromPdfCommand>
{
    public GenerateTrueFalseFromPdfCommandValidator()
    {
