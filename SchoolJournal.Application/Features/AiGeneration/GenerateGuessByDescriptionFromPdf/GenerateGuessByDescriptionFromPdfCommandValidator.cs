...
public sealed class GenerateGuessByDescriptionFromPdfCommandValidator : AbstractValidator<GenerateGuessByDescriptionFromPdfCommand>
{
    public GenerateGuessByDescriptionFromPdfCommandValidator()
    {
